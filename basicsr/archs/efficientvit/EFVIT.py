...
class EfficientVITStages(nn.Module):
    def __init__(self,in_channels=32, dim=32,
        ...
        self.conv1_stage2 = ConvLayer(in_channels=self.in_c, out_channels=self.in_c)
        self.conv1_stage3 = ConvLayer(in_channels=self.in_c*2, out_channels=self.in_c)
        self.conv1_stage4 = ConvLayer(in_channels=self.in_c*4, out_channels=self.in_c)
